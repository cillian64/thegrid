...
\section{Design}
\subsection{Layout}
\thegrid would occupy a space of approximately $24\metre \times 14\metre$.  Of
...
\begin{table}[ht]
    ...
    \begin{tabular}{l|r|r|r}
        ...
        \hline
        $\frac{3}{4}''$ alu angle, 5m & 2.91 & 38 & 98.94\\
                 White LED strips, 5m & 1.83 & 50 & 91.45\\
$0.75\milli\metre^2$ cable, 100m reel, twin core & 17.88 & 5 & 89.40\\
                               Camera & 15.66 & 1 & 15.66\\
                               Camera Coax$^\dagger$ & 10.00 & 1 & 10.00\\
                              ATX PSU$^\dagger$ & 20.00 & 4 & 80.00\\
...
\begin{figure}[h]
      ...
      \draw (0cm, -0.5cm) node [below] {guying radius 10\metre};
