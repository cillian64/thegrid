...
A prototype pole was constructed from $20\milli\metre 20\milli\metre
1.5\milli\metre$ aluminium section (c.f. $19\milli\metre 19\milli\metre
1.59\milli\metre$ for the final design).  RGB LED strip powered by a bench
power supply was attached.  This test confirmed the structural rigidity of the
pole design as well as the effectiveness of lighting with 30LED/$\metre$ strip.
