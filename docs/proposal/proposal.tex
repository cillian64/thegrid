...
\begin{figure}[h]
    ...
    \draw[decoration={border,segment length=2mm,amplitude=1.2mm,mirror,angle=45},decorate] (4.5cm, -1.6cm) -- (3.2cm, -1.6cm) -- (3.2cm, 1.6cm) -- (4.5cm, 1.6cm);
