...
$$ I_{xx} = 2 t \sqrt{2} \int_0^{a/\sqrt{2}} \! y^2 \, \mathrm{d}y
    = \frac{a^3 t}{3} $$
...
$$ \bar{y} = \frac{\int \! y \, \mathrm{d}A}{A}
= \frac{1}{2 a t} \cdot 2 \int_0^{a/\sqrt{2}} \! x t \sqrt{2} \, \mathrm{d}x
= \frac{a}{2 \sqrt{2}} $$

The final $I_{x'x'}$, hereafter referred to as $I$, is:

\begin{align*}
I &= \frac{a^3 t}{3} + 2 a t \left( \frac{a}{2 \sqrt{2}} \right)^2 \\
  &= \frac{7}{12} a^3 t
\end{align*}

For our beam, $a=\frac{3}{4}"$, $t=\frac{1}{16}"$, giving
$I=4.76 \times 10^{-8} \metre^4$
