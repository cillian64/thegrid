...
\title{\thegrid\\\small{\textsc{Technicolour Edition}}}
...
strips coordinated by a central control system.  User presence is detected by
an infrared computer vision system allowing both predefined and interactive
displays.
\\
~
\\
...
\begin{figure}[h]
    ...
    \caption{A computer graphics simulation of \thegrid lit up in white.}
\end{figure}
...
Each LED strip will be controlled using three MOSFET drivers on a control unit
per-pole. These are networked to a central control computer.

\subsubsection{Power}
% TODO check maximum power usage
...
5050-sized RGB LEDs. These strips take 12VDC input and are readily obtained
...
\begin{table}[ht]
    ...
    \begin{tabular}{l|r|r|r}
        ...
        New 30LED/m 5m RGB LED strip             &  7.50 & 50 & 375.00 \\
        New controller units$^\dagger$           &  8.00 & 50 & 400.00 \\
